            ...
            <ul class="items">
                <li class="item">
                    <div class="inner">
                        ...
                        <img class="image" src="<? echo $url_prefix; ?>slide1.png" alt="">
                    </div>
                </li>
                <li class="item"></li>
            </ul>
        ...
        <div class="cards">
            <div class="card">
                ...
                <div class="image-wrapper">
                    <img class="image" src="<? echo $url_prefix; ?>card1.jpg" alt="">
                </div>
    ...
    <div class="col-md-12 cards-wrapper">
        <div class="cards">
            <div class="card">
                <div class="marker">Хит</div>
                <div class="image-wrapper">
                    <img class="image" src="<? echo $url_prefix; ?>card2.jpg" alt="">
                </div>
                <a class="category" href="/">Камера видеонаблюдения</a>
                <a class="name" href="/">FALCON EYE FE-D80C</a>
    ...
    <div class="col-md-12 cards-wrapper">
        <div class="cards">
            <div class="card">
                ...
                <div class="image-wrapper">
                    <img class="image" src="<? echo $url_prefix; ?>card3.jpg" alt="">
                </div>
                <a class="category" href="/">Камера видеонаблюдения</a>
                <a class="name" href="/">FALCON EYE FE-D80C</a>
